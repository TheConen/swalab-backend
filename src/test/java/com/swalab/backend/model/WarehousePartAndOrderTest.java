...
public class WarehousePartAndOrderTest {
    ...
    @Test
    public void getId() {
        assertThat(testWarehousePartAndOrder.getId()).isEqualTo(id);
    }
    ...
    public void setId() {
        ...
        testWarehousePartAndOrder.setId(newId);
        assertThat(testWarehousePartAndOrder.getId()).isEqualTo(newId);
    }
}